...
bool wxEncodingConverter::Init(wxFontEncoding input_enc, wxFontEncoding output_enc, int method)
{
    ...
    if (input_enc == wxFONTENCODING_UNICODE)
    {
        ...
        for (i = 0; i < 128; i++)  m_Table[i] = (wchar_t)i;         for (i = 128; i < 65536; i++)  m_Table[i] = (wchar_t)0;
        ...
        for (i = 0; i < 128; i++)  m_Table[i] = (wchar_t)i; 
        if (output_enc == wxFONTENCODING_UNICODE)
        {
...
static const wxFontEncoding
    EquivalentEncodings[][NUM_OF_PLATFORMS][ENC_PER_PLATFORM+1] = {
        ...
        {
         {wxFONTENCODING_ISO8859_1, wxFONTENCODING_ISO8859_15, STOP},
         {wxFONTENCODING_CP1252, STOP},
         {wxFONTENCODING_MACROMAN, STOP}
    },

        {
         {wxFONTENCODING_ISO8859_2, STOP},
         {wxFONTENCODING_CP1250, STOP},
         {wxFONTENCODING_MACCENTRALEUR, STOP}
    },

        {
         {wxFONTENCODING_ISO8859_13, wxFONTENCODING_ISO8859_4, STOP},
         {wxFONTENCODING_CP1257, STOP},
         {STOP}
    },

        {
         {wxFONTENCODING_ISO8859_8, STOP},
         {wxFONTENCODING_CP1255, STOP},
         {wxFONTENCODING_MACHEBREW, STOP}
    },

        {
         {wxFONTENCODING_ISO8859_7, STOP},
         {wxFONTENCODING_CP1253, STOP},
         {wxFONTENCODING_MACGREEK, STOP}
    },

        {
         {wxFONTENCODING_ISO8859_6, STOP},
         {wxFONTENCODING_CP1256, STOP},
         {wxFONTENCODING_MACARABIC, STOP}
    },

        {
         {wxFONTENCODING_ISO8859_9, STOP},
         {wxFONTENCODING_CP1254, STOP},
         {wxFONTENCODING_MACTURKISH, STOP}
    },

        {
         {wxFONTENCODING_KOI8, wxFONTENCODING_KOI8_U, wxFONTENCODING_ISO8859_5, STOP},
         {wxFONTENCODING_CP1251, STOP},
         {wxFONTENCODING_MACCYRILLIC, STOP}
    },
...
wxFontEncodingArray wxEncodingConverter::GetAllEquivalents(wxFontEncoding enc)
{
    ...
    arr = GetPlatformEquivalents(enc); 
    clas = 0;
    while (EquivalentEncodings[clas][0][0] != STOP)
    {
        for (i = 0; i < NUM_OF_PLATFORMS; i++)
