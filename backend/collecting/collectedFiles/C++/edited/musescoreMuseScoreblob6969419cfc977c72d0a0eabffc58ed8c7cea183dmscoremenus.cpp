...
Palette* MuseScore::newFramePalette()
      ...
      if (enableExperimental) {
            static const IconAction bpa[] = {
                  ...
                  { IconType::FFRAME,   "insert-fretframe" },                      { IconType::MEASURE,  "insert-measure" },
                  { IconType::NONE,     ""}
                  };
...
Palette* MuseScore::newRepeatsPalette()
      ...
      for (int i = 0; i < markerTypeTableSize(); i++) {
            if(markerTypeTable[i].type == Marker::Type::CODETTA)                   continue;
      ...
      switch (t) {
            ...
            case PaletteType::ADVANCED: {
                  ...
                  static const std::vector<SymId> art {
                        ...
                        SymId::articSoftAccentAbove,                                            SymId::articSoftAccentStaccatoAbove,
                  ...
                  tb->points().append(PitchValue(0,     0, false));                       tb->points().append(PitchValue(30, -100, false));
...
Palette* MuseScore::newOrnamentsPalette()
      ...
      sp->setDrawGrid(true);
            ...
            SymId::ornamentPrecompMordentUpperPrefix,                   SymId::ornamentUpMordent,
...
void MuseScore::showPalette(bool visible)
      ...
      if (paletteBox)               paletteBox->setVisible(visible);
...
Palette* MuseScore::newTempoPalette(PaletteType t)
      ...
      static const TempoPattern tps[] = {
            TempoPattern("<sym>metNoteHalfUp</sym> = 80",    80.0/ 30.0, false, false, true, true, false),                            TempoPattern("<sym>metNoteQuarterUp</sym> = 80", 80.0/ 60.0, false, false, true, true, false),                            TempoPattern("<sym>metNote8thUp</sym> = 80",     80.0/120.0, false, false, true, true, false),                            TempoPattern("<sym>metNoteHalfUp</sym><sym>space</sym><sym>metAugmentationDot</sym> = 80",    120/ 30.0, false, false, true, false, false),               TempoPattern("<sym>metNoteQuarterUp</sym><sym>space</sym><sym>metAugmentationDot</sym> = 80", 120/ 60.0, false, false, true, true, false),               TempoPattern("<sym>metNote8thUp</sym><sym>space</sym><sym>metAugmentationDot</sym> = 80",     120/120.0, false, false, true, false, false),   
