...
enum {
    TYPE_OLDTAR,        TYPE_GNUTAR,        TYPE_USTAR      };
...
{
    { wxT("name"), 0 },           { wxT("mode"), 100 },         { wxT("uid"), 108 },          { wxT("gid"), 116 },          { wxT("size"), 124 },         { wxT("mtime"), 136 },        { wxT("chksum"), 148 },       { wxT("typeflag"), 156 },     { wxT("linkname"), 157 },     { wxT("magic"), 257 },        { wxT("version"), 263 },      { wxT("uname"), 265 },        { wxT("gname"), 297 },        { wxT("devmajor"), 329 },     { wxT("devminor"), 337 },     { wxT("prefix"), 345 },       { wxT("unused"), 500 },       { NULL, TAR_BLOCKSIZE }
};
...
wxUint32 wxTarHeaderBlock::Sum(bool SignedSum )
{
...
wxString wxTarEntry::GetName(wxPathFormat format ) const
{
