...
#pragma warning(push)
#pragma warning(disable : 4244) #pragma warning(disable : 4127) #pragma warning(disable : 4702) #else
...
private:
  template <typename T> value(const T *);   template <typename Iter> static void _indent(Iter os, int indent);
