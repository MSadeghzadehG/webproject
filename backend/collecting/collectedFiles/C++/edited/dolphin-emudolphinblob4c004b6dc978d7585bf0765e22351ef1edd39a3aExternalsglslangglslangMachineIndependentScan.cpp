...
bool TInputScanner::scanVersion(int& version, EProfile& profile, bool& notFirstToken)
{
    ...
    bool versionNotFirst = false;      notFirstToken = false;             version = 0;      profile = ENoProfile;
    ...
    do {
        ...
        if (version == 0) {
            ...
            c = get();
                ...
                const int maxProfileLength = 13;          char profileString[maxProfileLength];
        int profileLength;
...
void TScanContext::fillInKeywordMap()
{
    ...
    (*KeywordMap)["samplerExternalOES"] =      SAMPLEREXTERNALOES; 
