...
enum class CondType : char {
      None,
      Time_Parameters    = 0x09,       Bar_Number         = 0x0A,       Decorator          = 0x16,
      Tempo              = 0x1C,       Text               = 0x1D,       Expression         = 0x25,       Barline_Parameters = 0x30,       Repeat             = 0x31,       Numeric_Ending     = 0x32,
      };
...
enum class BdatType : unsigned char {
      ...
      Clef                  = 0x12,
      Dynamics              = 0x13,
      Wedge                 = 0x14,       Glissando             = 0x15,
      Decorator             = 0x16,       Key                   = 0x17,
      Lyric                 = 0x18,
      Octave_Shift          = 0x19,
      Slur                  = 0x1B,
      Text                  = 0x1D,
      Tie                   = 0x1E,
      Tuplet                = 0x1F,
      Guitar_Bend           = 0x21,       Guitar_Barre          = 0x22,       Pedal                 = 0x23,
      KuoHao                = 0x24,       Expressions           = 0x25,
      Harp_Pedal            = 0x26,
      Multi_Measure_Rest    = 0x27,
      Harmony_GuitarFrame   = 0x28,
      Graphics_40           = 0x40,       Graphics_RoundRect    = 0x41,
      Graphics_Rect         = 0x42,
      Graphics_Round        = 0x43,
      Graphics_Line         = 0x44,
      Graphics_Curve        = 0x45,
...
enum class ClefType : char {
      Treble = 0x00,       Bass,                Alto,                UpAlto,              DownDownAlto,        DownAlto,            UpUpAlto,            Treble8va,           Bass8va,             Treble8vb,           Bass8vb,             Percussion1,         Percussion2,         TAB                  };
...
enum class ArticulationType : char {
      ...
      Open_String                  = 0x30,       Guitar_Lift                  = 0x46,
...
enum class WedgeType : char {
      Cres_Line = 0,       Double_Line,         Decresc_Line,        Cres,                Decresc              };
...
enum class BarLineType : char {
      Default = 0,       Double,            RepeatLeft,        RepeatRight,       Final,             Dashed,            Null               } ;

enum class NoteDuration {
      D_256 = 15,
      D_128 = NoteDuration::D_256 * 2,                 D_64 = NoteDuration::D_128 * 2,                  D_32 = NoteDuration::D_64 * 2,                   D_16 = NoteDuration::D_32 * 2,                   D_8 = NoteDuration::D_16 * 2,                    D_4 = NoteDuration::D_8 * 2,                     D_2 = NoteDuration::D_4 * 2,                     D_Whole = NoteDuration::D_2 * 2,                 D_Double_Whole = NoteDuration::D_Whole * 2       };
...
enum class KeyType : char {
      Key_C = 0,		      Key_Bass_1,		      Key_Bass_2,		      Key_Bass_3,		      Key_Bass_4,		      Key_Bass_5,		      Key_Bass_6,		      Key_Bass_7,		      Key_Sharp_1,	      Key_Sharp_2,	      Key_Sharp_3,	      Key_Sharp_4,	      Key_Sharp_5,	      Key_Sharp_6,	      Key_Sharp_7		      };
...
public:
      ...
      MeasurePos shiftOffset(int offset) const; 
...
public:
      virtual void setLine(int line);       virtual int getLine(void) const;
...
public:
      ...
      bool getShow() const;
            ...
            void setColor(unsigned int color);       unsigned int getColor() const;
...
public:
      ...
      MeasureData* getMeasureData(int part, int staff, int bar) const;
...
private:
      int channel_;		      int volume_;		      int pitchShift_;	      int pan_;			      int patch_;			      int stemType_;		      };
...
public:
      ...
      void setPatch(unsigned int patch);       unsigned int getPatch() const;
...
public:
      ...
      void setLineInterval(int interval);	      int getLineInterval() const;

      void setStaffInterval(int interval);
      int getStaffInterval() const;

      void setStaffInlineInterval(int interval);       int getStaffInlineInterval() const;
...
public:
      ...
      void setAccidental(int type);		      AccidentalType getAccidental() const;
      ...
      void setHeadType(int type);		      NoteHeadType getHeadType() const;

      void setTiePos(int tiePos);
      TiePos getTiePos() const;

      void setOffsetStaff(int offset);	      int getOffsetStaff() const;
...
public:
      void setArtType(int type);      ArticulationType getArtType() const;
...
private:
      ...
      bool stemUp_;
      bool showStem_;
      int stemLength_;	      int noteShift_;
...
public:
      ...
      void setNote(int note);      int getNote() const;
...
public:
      void setSingleRepeat(bool single);       bool getSingleRepeat() const;
...
public:
      ...
      void setRoot(int root=0);      int getRoot() const;
...
public:
      void setClefType(int type);	      ClefType getClefType() const;
...
public:
      void setContainerCount(int count);       int getContainerCount() const;
      ...
      void setNoteTimePercent(int percent);       int getNoteTimePercent() const;
...
public:
      void setDynamicsType(int type);      DynamicsType getDynamicsType() const;
...
public:
      ...
      void setPlayOffset(int offset);       int getPlayOffset() const;

      OffsetElement* getPedalHandle() const; 
private:
      bool half_;
      bool playback_;
      int playOffset_;
...
public:
      ...
      void setKuohaoType(int type);      KuoHaoType getKuohaoType() const;
...
public:
      void setShowType(int type);      int getShowType() const;

      void setShowCharFlag(int flag);      int getShowCharFlag() const;
...
public:
      void setLeftNoteType(int type);      NoteType getLeftNoteType() const;
      ...
      void setTypeTempo(double tempo);       double getTypeTempo() const;
      double getQuarterTempo() const;

      void setLeftText(const QString& str);      QString getLeftText() const;
...
public:
      ...
      void setIsSymbol(bool symbol);       bool getIsSymbol() const;

      void setBeatLength(int length);       int getBeatLength() const;

      void setBarLength(int length);       int getBarLength() const;
...
public:
      void setKey(int key);       int getKey() const;
...
public:
      ...
      void setAlign(int align);      int getAlign() const;

      void setShowFlag(int flag);       int getShowFlag() const;
...
private:
      ...
      int repeatCount_;
      double typeTempo_;       bool pickup_;
...
public:
      ...
      int toInt() const;
      QByteArray toStrByteArray() const;					      QByteArray fixedSizeBufferToStrByteArray() const;	
private:
...
private:
      ...
      bool parsePairLinesBlock(PairEnds* ptr);       bool parseOffsetElement(OffsetElement* ptr);
private:
...
private:
      ...
      bool readSizeChunk(SizeChunk* sizeChunk);       bool readDataChunk(Block* block, unsigned int size);
