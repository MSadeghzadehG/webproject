                               ...
                               wxCoord width, wxCoord height)
{
    ...
    wxCoord x2 = x1 + width,
        ...
        wxCoord x3 = x1 + (4*width) / 10,               y3 = y1 + height / 2;           DoDrawLine(x1, y3, x3, y2);
                                    ...
                                    wxDirection nDirection)
{
    ...
    if ( nDirection == wxEAST || nDirection == wxWEST )
    {
        ...
        wxInt32 w = x;                      wxInt32 xDelta = w/256;             if (xDelta < 1)
            xDelta = 1;
        ...
        while (x >= xDelta)
        {
            ...
            else                 DoDrawRectangle(rect.GetLeft()+x, rect.GetTop(),
                        xDelta, rect.GetHeight());
        }
    }
    else      {
        wxInt32 y = rect.GetHeight();
        wxInt32 w = y;                      wxInt32 yDelta = w/255;             if (yDelta < 1)
            yDelta = 1;
        ...
        while (y > 0)
        {
            ...
            else                 DoDrawRectangle(rect.GetLeft(), rect.GetBottom()-y-yDelta+1,
                        rect.GetWidth(), yDelta);
        }
    }
