...
wxUint32 wxMacGetSystemEncFromFontEnc(wxFontEncoding encoding)
{
...
#else
        encoding = wxFONTENCODING_SYSTEM; #endif
    }
    ...
    case wxFONTENCODING_KOI8 :
        ...
        break ;
    case wxFONTENCODING_ALTERNATIVE :         enc = kCFStringEncodingDOSRussian;
        break ;
...
wxCFStringRef::wxCFStringRef( const wxString &st , wxFontEncoding WXUNUSED_IN_UNICODE(encoding) )
{
    ...
    #error "unsupported Unicode representation"
        ...
        reset( CFStringCreateWithBytes( kCFAllocatorDefault,
            (const UInt8*)data, size, cfencoding, false  ) );
#else         reset( CFStringCreateWithCString( kCFAllocatorSystemDefault , str.c_str() ,
