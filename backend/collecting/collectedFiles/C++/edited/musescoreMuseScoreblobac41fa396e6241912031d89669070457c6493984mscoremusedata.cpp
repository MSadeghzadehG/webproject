...
void MuseData::readNote(Part* part, const QString& s)
      ...
      if (s.size() >= 22) {
            ...
            if (a == 3 && b == 2) {                         if (chordRest && chordRest->tuplet() && ntuplet) {
...
Measure* MuseData::createMeasure()
      ...
      for (MeasureBase* mb = score->first(); mb; mb = mb->next()) {
            ...
            if (curTick > st && curTick < (st+l)) {
                  #if 0                   Fraction f = score->sigmap()->timesig(st).fraction();
      ...
      for (; line < sl.size(); ++line) {
            ...
            switch(c) {
                  ...
                  case 'G':
                        readNote(part, s);
                        break;
                  case ' ':                                 readChord(part, s);
                        break;
                  case 'r':
                        readRest(part, s);
                        break;
                  case 'g':                           case 'c':                           case 'f':                                 break;
                  case 'b':                           case 'i':                                 readBackup(s);
                        break;
                  case 'm':                                 measure = createMeasure();
                        break;
                  case '*':                                 break;
                  case 'P':                                 break;
                  case 'S':                                 break;
