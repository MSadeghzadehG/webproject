...
wxBEGIN_PROPERTIES_TABLE(wxSlider)
    ...
    wxPROPERTY( Minimum, int, SetMin, GetMin, 0, 0 , \
                wxT("Helpstring"), wxT("group"))
    wxPROPERTY( Maximum, int, SetMax, GetMax, 0, 0 , \
                wxT("Helpstring"), wxT("group"))
    wxPROPERTY( PageSize, int, SetPageSize, GetLineSize, 1, 0 , \
                wxT("Helpstring"), wxT("group"))
    wxPROPERTY( LineSize, int, SetLineSize, GetLineSize, 1, 0 , \
                wxT("Helpstring"), wxT("group"))
    wxPROPERTY( ThumbLength, int, SetThumbLength, GetThumbLength, 1, 0 , \
                wxT("Helpstring"), wxT("group"))
