...
MeasureData* OveSong::getMeasureData(int part, int staff, int bar) const {
      int trackId = partStaffToTrack(part, staff);
...
void Track::setStartClef(int clef) {
...
void Track::setDisplayPercent(unsigned int percent) {
...
BarNumber::BarNumber() {
      ...
      align_ = 0;
      showFlag_ = 1;       barRange_ = 1;       prefix_ = QString();
      }
...
void BarNumber::setAlign(int align)      {
      align_ = align;
      }
...
bool StreamHandle::write(char* , int ) {
      return true;
      }
...
void FixedBlock::resize(unsigned int ) {
            }
...
bool TrackParse::parse() {
      ...
      if( !jump(8) ) { return false; }       if( !jump(1) ) { return false; }
...
bool BarsParse::parseBarlineParameters(Measure* measure, int ) {
      Block placeHolder;
...
bool BarsParse::parseNumericEndings(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseTempo(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseBarNumber(Measure* measure, int ) {
      Block placeHolder;
...
bool BarsParse::parseRepeatSymbol(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseBdat(Measure* , MeasureData* measureData, SizeChunk* chunk) {
      Block placeHolder;
...
bool BarsParse::parseNoteRest(MeasureData* measureData, int length, BdatType type) {
      ...
      if( type == BdatType::Rest ) {
            ...
            container->setStemLength(getInt(stemOffset, 7)+7);
...
bool BarsParse::parseTie(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseTuplet(MeasureData* measureData, int ) {
      Block placeHolder;
...
QString binaryToHarmonyType(int bin) {
      ...
      switch (bin) {
            ...
            case 0x0889: { type = "min(\u266e7)";     break; }               case 0x088D: { type = "min9(\u266e7)";    break; }               case 0x0891: { type = "maj7";             break; }
            ...
            case 0x0A0D: { type = "min69(\u266e7)";   break; }               case 0x0A11: { type = "maj13";            break; }
            ...
            case 0x0A89: { type = "min13(\u266e7)";   break; }               case 0x0A8D: { type = "min69(\u266e7)";   break; }               case 0x0A91: { type = "maj13";            break; }
            case 0x0A95: { type = "maj13";            break; }
            case 0x0AAD: { type = "min13(\u266e7)";   break; }               case 0x0AD5: { type = "maj13#11";         break; }
...
bool BarsParse::parseHarmony(MeasureData* measureData, int ) {
      Block placeHolder;
      ...
      harmony->setBassOnBottom((getHighNibble(placeHolder.toUnsignedInt()) & 0x4));
            ...
            case 0: {
                  harmony->setAlterRoot(0);                   break;
                  }
            case 16: {
                  harmony->setAlterRoot(-1);                   break;
                  }
            case 8: {
                  harmony->setAlterRoot(1);                   break;
                  }
            ...
            case 0: {
                  harmony->setAlterBass(0);                   break;
                  }
            case 2: {
                  harmony->setAlterBass(-1);                   break;
                  }
            case 1: {
                  harmony->setAlterBass(1);                   break;
                  }
...
bool BarsParse::parseClef(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseSlur(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseGlissando(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseDynamics(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseKey(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseKuohao(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseHarpPedal(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseMultiMeasureRest(MeasureData* measureData, int ) {
      Block placeHolder(2);
...
bool BarsParse::parseOctaveShift(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseMidiController(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseMidiProgramChange(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseMidiChannelPressure(MeasureData* measureData, int ) {
      Block placeHolder;
...
bool BarsParse::parseMidiPitchWheel(MeasureData* measureData, int ) {
      Block placeHolder;
...
void OveOrganizer::organizeContainers(int , int ,
...
void OveOrganizer::organizeMusicDatas(int , int , Measure* measure, MeasureData* measureData) {
      int i;
...
bool getMiddleUnit(
            OveSong* ove, int , int ,
            Measure* measure1, Measure* measure2, int unit1, int ,
            Measure* middleMeasure, int& middleUnit) {
      Q_UNUSED(middleMeasure);       QList<int> barUnits;
      int i;
...
int chunkTypeToMaxTimes(ChunkType type) {
      ...
      switch (type) {
            ...
            case ChunkType::TRKL: {                  maxTimes = 1;
                  break;
                  }
            case ChunkType::PAGL: {                  maxTimes = 1;
                  break;
                  }
                                                case ChunkType::LINL: {
                  maxTimes = 1;
...
bool OveSerialize::readChunkName(Chunk* , const QString& name) {
      if (streamHandle_ == 0)
            return false;
