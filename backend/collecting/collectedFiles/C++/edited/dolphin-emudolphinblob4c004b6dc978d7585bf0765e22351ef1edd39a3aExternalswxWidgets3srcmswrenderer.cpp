...
#include "wx/wxprec.h"
    ...
    #include "wx/string.h"
    #include "wx/window.h"
    #include "wx/control.h"         #include "wx/dc.h"
...
#include "wx/msw/uxtheme.h"
    ...
    #define DTT_TEXTCOLOR       (1UL << 0)          #define DTT_STATEID         (1UL << 8)      
                                ...
                                wxEllipsizeMode ellipsizeMode)
{
    ...
    if ( te->DrawThemeTextEx &&             te->IsThemePartDefined(hTheme, LVP_LISTITEM, 0) )
    {
        RECT rc;
        wxCopyRectToRECT(rect, rc);
