...
const int FNT_PIXMAP_WIDTH = 512; 
...
static std::vector<uint8_t> generate_bmp_header(const image8& img)
{
	...
	write_le32(result, HEADER_SIZE);
		...
		write_le32(result, 40);                 	write_le32(result, img.width);          	write_le32(result, ~img.height() + 1);  	write_le16(result, 1);                  	write_le16(result, 8);                  	write_le32(result, 0);                  	write_le32(result, 0);                  	write_le32(result, 0);                  	write_le32(result, 0);                  	write_le32(result, 0);                  	write_le32(result, 0);                  
