...
wxVariant::wxVariant(wxVariantData* data, const wxString& name)     : wxObject()
{
    m_refData = data;
    m_name = name;
}
...
public:
    ...
    virtual bool Read(wxInputStream& str);
    virtual bool Write(wxOutputStream &str) const;
#endif     virtual wxString GetType() const wxOVERRIDE { return wxT("double"); }
...
public:
    ...
    virtual bool Read(wxInputStream& str);
    virtual bool Write(wxOutputStream& str) const;
#endif     virtual wxString GetType() const wxOVERRIDE { return wxT("bool"); }
...
public:
    ...
    virtual bool Read(wxInputStream& str);
    virtual bool Write(wxOutputStream& str) const;
#endif     virtual wxString GetType() const wxOVERRIDE { return wxT("char"); }
...
public:
    ...
    virtual bool Read(wxInputStream& str);
    virtual bool Write(wxOutputStream& str) const;
#endif     virtual wxString GetType() const wxOVERRIDE { return wxT("string"); }
...
wxVariant::wxVariant(const wxDateTime& val, const wxString& name) {
...
wxVariant::wxVariant(const wxArrayString& val, const wxString& name) {
...
wxVariant::wxVariant(const wxVariantList& val, const wxString& name) {
