...
bool Config::LoadINI(const std::string& default_contents, bool retry) {
    ...
    if (sdl2_config->ParseError() < 0) {
        if (retry) {
            ...
            sdl2_config = std::make_unique<INIReader>(location); 
...
void Config::ReadValues() {
    ...
    Settings::values.telemetry_endpoint_url = sdl2_config->Get(
        "WebService", "telemetry_endpoint_url", "https:    Settings::values.verify_endpoint_url = sdl2_config->Get(
        "WebService", "verify_endpoint_url", "https:    Settings::values.announce_multiplayer_room_endpoint_url =
        sdl2_config->Get("WebService", "announce_multiplayer_room_endpoint_url",
                         "https:    Settings::values.citra_username = sdl2_config->Get("WebService", "citra_username", "");
