...
@SuppressFileSystems("WindowsFS") public class FileSystemUtilsTests extends ESTestCase {
    ...
    public void testOpenFileURLStream() throws IOException {
        URL urlWithWrongProtocol = new URL("http:        try (InputStream is = FileSystemUtils.openFileURLStream(urlWithWrongProtocol)) {
