...
public final class ClassGenerator {
    ...
    private static final Map<ClassLoader, ClassPool> POOL_MAP = new ConcurrentHashMap<ClassLoader, ClassPool>();     private ClassPool mPool;
    private CtClass mCtc;
    private String mClassName, mSuperClass;
    private Set<String> mInterfaces;
    private List<String> mFields, mConstructors, mMethods;
    private Map<String, Method> mCopyMethods;     private Map<String, Constructor<?>> mCopyConstructors;     private boolean mDefaultConstructor = false;
    ...
    public Class<?> toClass(ClassLoader loader, ProtectionDomain pd) {
        ...
        try {
            ...
            mCtc.addInterface(mPool.get(DC.class.getName()));             if (mInterfaces != null)
            ...
            if (mConstructors != null) {
                for (String code : mConstructors) {
                    if (code.charAt(0) == ':') {
                        ...
                        String[] sn = mCtc.getSimpleName().split("\\$+");                         mCtc.addConstructor(CtNewConstructor.make(code.replaceFirst(SIMPLE_NAME_TAG, sn[sn.length - 1]), mCtc));
                    }
                }
            }
