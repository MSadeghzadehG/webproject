...
public class SerializeWriterTest_13 extends TestCase {
    ...
    public void test_default() throws Exception {
        Assert.assertEquals("{\"\":\"\"}",                             JSON.toJSONStringZ(Collections.singletonMap("", ""),                                                SerializeConfig.getGlobalInstance()));
    }

    public void test_single() throws Exception {
        Assert.assertEquals("{'':''}",                             JSON.toJSONStringZ(Collections.singletonMap("", ""),                                                SerializeConfig.getGlobalInstance(), SerializerFeature.UseSingleQuotes));
    }
