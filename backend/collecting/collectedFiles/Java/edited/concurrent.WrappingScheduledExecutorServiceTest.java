...
public class WrappingScheduledExecutorServiceTest extends TestCase {
  ...
  public void testSchedule() {
    ...
    @SuppressWarnings("unused")     Future<?> possiblyIgnoredError = testExecutor.schedule(DO_NOTHING, 10, TimeUnit.MINUTES);
    mock.assertLastMethodCalled("scheduleRunnable", 10, TimeUnit.MINUTES);

    @SuppressWarnings("unused")     Future<?> possiblyIgnoredError1 =
