...
public class DependencyBank {
	...
	static String libGDXSnapshotsUrl = "https:	static String libGDXReleaseUrl = "https:
	...
	public enum ProjectDependency {
		...
		CONTROLLERS(
			...
			new String[]{}, 			new String[]{}, 			new String[]{"com.badlogicgames.gdx:gdx-controllers:$gdxVersion:sources", "com.badlogicgames.gdx:gdx-controllers-gwt:$gdxVersion", "com.badlogicgames.gdx:gdx-controllers-gwt:$gdxVersion:sources"},
