...
public class TelnetCodecTest {
    ...
    public void testDecode_Person_WithEnter() throws IOException {
        ...
        testDecode_PersonWithEnterByte(new byte[]{'\n'}, false);         testDecode_PersonWithEnterByte(new byte[]{'\r'}, true);
    ...
    public void testDecode_WithExitByte() throws IOException {
        ...
        exitbytes.put(new byte[]{1, 3}, false);         exitbytes.put(new byte[]{-1, -12, -1, -3, 6}, true); 
        exitbytes.put(new byte[]{1, -1, -12, -1, -3, 6}, false);         exitbytes.put(new byte[]{-1, -19, -1, -3, 6}, true);  
