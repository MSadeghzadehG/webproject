...
public class GenericServiceTest {
    ...
    public void testGenericServiceException() {
        ...
        try {
            ...
            reference.setUrl("dubbo:            DemoService demoService = reference.get();
            try {
    ...
    public void testGenericReferenceException() {
        ...
        try {
            ...
            reference.setApplication(new ApplicationConfig("generic-consumer"));
            reference.setInterface(DemoService.class);
            reference.setUrl("dubbo:            reference.setGeneric(true);
    ...
    public void testGenericSerializationJava() throws Exception {
        ...
        try {
            ...
            reference.setApplication(new ApplicationConfig("generic-consumer"));
            reference.setInterface(DemoService.class);
            reference.setUrl("dubbo:            reference.setGeneric(Constants.GENERIC_SERIALIZATION_NATIVE_JAVA);
            GenericService genericService = reference.get();
            try {
                String name = "kimi";
    ...
    public void testGenericInvokeWithBeanSerialization() throws Exception {
        ...
        try {
            ...
            reference.setInterface(DemoService.class);
            reference.setUrl("dubbo:            reference.setGeneric(Constants.GENERIC_SERIALIZATION_BEAN);
            GenericService genericService = reference.get();
            User user = new User();
    ...
    public void testGenericImplementationWithBeanSerialization() throws Exception {
        ...
        try {
            ...
            ref.setUrl("dubbo:            DemoService demoService = ref.get();
            User user = new User();
            user.setName("zhangsan");
            List<User> users = new ArrayList<User>();
            users.add(user);
