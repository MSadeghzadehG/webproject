...
public class ParserConfig {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(Class<?> clazz, Type type) {
        ...
        if (asmEnable) {
            ...
            for (FieldInfo fieldInfo : beanInfo.fields) {
                ...
                if (fieldClass.isEnum()) {                     ObjectDeserializer fieldDeser = this.getDeserializer(fieldClass);
    ...
    public static Field getFieldFromCache(String fieldName, Map<String, Field> fieldCacheMap) {
        ...
        if (field == null) {
            ...
            if (c0 >= 'a' && c0 <= 'z') {
                ...
                chars[0] -= 32;                 String fieldNameX = new String(chars);
    ...
    public Class<?> checkAutoType(String typeName, Class<?> expectClass, int features) {
        ...
        if (h1 == 0xaf64164c86024f1aL) {             throw new JSONException("autoType is not support. " + typeName);
        }
