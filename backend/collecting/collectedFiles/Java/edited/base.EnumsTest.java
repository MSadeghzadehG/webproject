...
public class EnumsTest extends TestCase {
  ...
  @GwtIncompatible   public void testGetIfPresent_doesNotPreventClassUnloading() throws Exception {
    WeakReference<?> shadowLoaderReference = doTestClassUnloading();
    GcFinalization.awaitClear(shadowLoaderReference);
  }

            @GwtIncompatible   private WeakReference<?> doTestClassUnloading() throws Exception {
  ...
  @GwtIncompatible   public void testStringConverter_nullPointerTester() throws Exception {
    Converter<String, TestEnum> converter = Enums.stringConverter(TestEnum.class);
  ...
  @GwtIncompatible   public void testStringConverter_toString() {
    assertEquals(
  ...
  @GwtIncompatible   public void testGetField() {
  ...
  @GwtIncompatible   private URL[] getClassPathUrls() {
