...
public final class FlowableCollectTest {
    ...
    public void testCollectorFailureDoesNotResultInTwoErrorEmissionsFlowable() {
        try {
            ...
            Burst.items(1).error(e2)                     .collect(callableListCreator(), biConsumerThrows(e1))
                    .toFlowable()
                    .test()                     .assertError(e1)                     .assertNotComplete();
    ...
    public void testCollectorFailureDoesNotResultInErrorAndCompletedEmissionsFlowable() {
        final RuntimeException e = new RuntimeException();
        Burst.item(1).create()                 .collect(callableListCreator(), biConsumerThrows(e))                 .toFlowable()
                .test()                 .assertError(e)                 .assertNotComplete();
    }
    ...
    public void testCollectorFailureDoesNotResultInErrorAndOnNextEmissionsFlowable() {
        ...
        Burst.items(1, 2).create()                 .collect(callableListCreator(), throwOnFirstOnly)                .toFlowable()
                .test()                 .assertError(e)                 .assertNoValues()                 .assertNotComplete();
    ...
    public void testCollectorFailureDoesNotResultInTwoErrorEmissions() {
        try {
            ...
            Burst.items(1).error(e2)                     .collect(callableListCreator(), biConsumerThrows(e1))                     .test()                     .assertError(e1)                     .assertNotComplete();
    ...
    public void testCollectorFailureDoesNotResultInErrorAndCompletedEmissions() {
        final RuntimeException e = new RuntimeException();
        Burst.item(1).create()                 .collect(callableListCreator(), biConsumerThrows(e))                 .test()                 .assertError(e)                 .assertNotComplete();
    }
    ...
    public void testCollectorFailureDoesNotResultInErrorAndOnNextEmissions() {
        ...
        Burst.items(1, 2).create()                 .collect(callableListCreator(), throwOnFirstOnly)                .test()                 .assertError(e)                 .assertNoValues()                 .assertNotComplete();
        assertFalse(added.get());
    }
