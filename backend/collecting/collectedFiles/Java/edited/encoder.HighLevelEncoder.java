...
public final class HighLevelEncoder {
  ...
  static final int MODE_UPPER = 0;   static final int MODE_LOWER = 1;   static final int MODE_DIGIT = 2;   static final int MODE_MIXED = 3;   static final int MODE_PUNCT = 4; 
            static final int[][] LATCH_TABLE = {
    {
      0,
      (5 << 16) + 28,                    (5 << 16) + 30,                    (5 << 16) + 29,                    (10 << 16) + (29 << 5) + 30,     },
    {
      (9 << 16) + (30 << 4) + 14,        0,
      (5 << 16) + 30,                    (5 << 16) + 29,                    (10 << 16) + (29 << 5) + 30,     },
    {
      (4 << 16) + 14,                    (9 << 16) + (14 << 5) + 28,        0,
      (9 << 16) + (14 << 5) + 29,        (14 << 16) + (14 << 10) + (29 << 5) + 30,
                                       },
    {
      (5 << 16) + 29,                    (5 << 16) + 28,                    (10 << 16) + (29 << 5) + 30,       0,
      (5 << 16) + 30,                  },
    {
  ...
  static {
    ...
    for (int i = 0; i < punctTable.length; i++) {
      ...
      static final int[][] SHIFT_TABLE = new int[6][6];   static {
  ...
  private static void updateStateForPair(State state, int index, int pairCode, Collection<State> result) {
    ...
    if (pairCode == 3 || pairCode == 4) {
          ...
          .latchAndAppend(MODE_DIGIT, 16 - pairCode)            .latchAndAppend(MODE_DIGIT, 1);                   result.add(digitState);
    }
