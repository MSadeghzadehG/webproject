...
public class ConfigTest {
    ...
    public void testServiceClass() {
        ...
        ctx.start();
        try {
            DemoService demoService = refer("dubbo:            String hello = demoService.sayName("hello");
    ...
    public void testToString() {
        ...
        reference.setRegistry(new RegistryConfig(RegistryConfig.NO_AVAILABLE));
        reference.setInterface(DemoService.class);
        reference.setUrl("dubbo:        String str = reference.toString();
        assertTrue(str.startsWith("<dubbo:reference "));
        assertTrue(str.contains(" url=\"dubbo:        assertTrue(str.contains(" interface=\"com.alibaba.dubbo.config.spring.api.DemoService\" "));
    ...
    public void testMultiProtocolDefault() {
        ...
        ctx.start();
        try {
            DemoService demoService = refer("rmi:            String hello = demoService.sayName("hello");
            assertEquals("say:hello", hello);
        } finally {
            ctx.stop();
            ctx.close();
    ...
    public void testApiOverrideProperties() throws Exception {
        ...
        try {
            ...
            reference.setRegistry(new RegistryConfig(RegistryConfig.NO_AVAILABLE));
            reference.setInterface(DemoService.class);
            reference.setUrl("dubbo:            reference.get();
            try {
    ...
    public void testGenericServiceConfig() throws Exception {
        ...
        service.setRegistry(new RegistryConfig("mock:        service.setInterface(DemoService.class.getName());
