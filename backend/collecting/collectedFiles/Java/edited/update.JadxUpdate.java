...
public class JadxUpdate {
	...
	public static final String JADX_RELEASES_URL = "https:
	private static final String GITHUB_API_URL = "https:	private static final String GITHUB_RELEASES_URL = GITHUB_API_URL + "repos/skylot/jadx/releases";
