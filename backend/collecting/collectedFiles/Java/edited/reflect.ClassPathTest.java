...
public class ClassPathTest extends TestCase {
  ...
  @AndroidIncompatible   public void testClassPathEntries_emptyURLClassLoader_noParent() {
  ...
  @AndroidIncompatible     public void testClassPathEntries_URLClassLoader_pathWithSpace() throws Exception {
    URL url = new URL("file:    URLClassLoader classloader = new URLClassLoader(new URL[] {url}, null);
    assertThat(ClassPath.Scanner.getClassPathEntries(classloader))
        .containsExactly(new File("/c:/Documents and Settings/"), classloader);
  }

  @AndroidIncompatible     public void testClassPathEntries_URLClassLoader_pathWithEscapedSpace() throws Exception {
    URL url = new URL("file:    URLClassLoader classloader = new URLClassLoader(new URL[] {url}, null);
    assertThat(ClassPath.Scanner.getClassPathEntries(classloader))
        .containsExactly(new File("/c:/Documents and Settings/"), classloader);
  }
    ...
    assertThat(ClassPath.toFile(new URL("file:        .isEqualTo(new File("/c:/Documents and Settings/"));
    assertThat(ClassPath.toFile(new URL("file:        .isEqualTo(new File("/c:/Documents ~ Settings, or not/11-12 12:05"));
  }

    @AndroidIncompatible   public void testToFile_AndroidIncompatible() throws Exception {
    assertThat(ClassPath.toFile(new URL("file:        .isEqualTo(new File("/c:\\Documents ~ Settings, or not\\11-12 12:05"));
    assertThat(ClassPath.toFile(new URL("file:        .isEqualTo(new File("/C:\\Program Files\\Apache Software Foundation/"));
    assertThat(ClassPath.toFile(new URL("file:        .isEqualTo(new File("/C:\\\u20320 \u22909"));
  }

  @AndroidIncompatible     public void testJarFileWithSpaces() throws Exception {
  ...
  public void testGetClassPathUrls() throws Exception {
    ...
    try {
      ...
      assertThat(urls.get(1)).isEqualTo(new URL("file:
      ...
      assertThat(urls.get(3)).isEqualTo(new URL("file:
  ...
  @AndroidIncompatible   private static void deleteRecursivelyOrLog(java.nio.file.Path path) {
    try {
