...
public final class ParsedReaderResultTestCase extends Assert {
  ...
  public void testBookmarkType() {
    doTestResult("MEBKM:URL:google.com;;", "http:    doTestResult("MEBKM:URL:google.com;TITLE:Google;;", "Google\nhttp:        ParsedResultType.URI);
    doTestResult("MEBKM:TITLE:Google;URL:google.com;;", "Google\nhttp:        ParsedResultType.URI);
    doTestResult("MEBKM:URL:http:    doTestResult("MEBKM:URL:HTTPS:  }

  @Test
  public void testURLTOType() {
    doTestResult("urlto:foo:bar.com", "foo\nhttp:    doTestResult("URLTO:foo:bar.com", "foo\nhttp:    doTestResult("URLTO::bar.com", "http:    doTestResult("URLTO::http:  }
  ...
  @Test
  public void testURI() {
    doTestResult("http:    doTestResult("google.com", "http:    doTestResult("https:    doTestResult("HTTP:    doTestResult("http:    doTestResult("https:    doTestResult("google.com:443", "http:    doTestResult("google.com:443/", "http:    doTestResult("google.com:443/foobar", "http:    doTestResult("http:    doTestResult("https:    doTestResult("ftp:    doTestResult("gopher:  }
  ...
  private static void doTestResult(String contents,
    ...
    doTestResult(contents, goldenResult, type, BarcodeFormat.QR_CODE);   }
