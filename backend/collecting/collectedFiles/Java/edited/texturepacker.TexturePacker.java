...
public class TexturePacker {
	...
	static public class Rect implements Comparable<Rect> {
		...
		public int x, y;
		public int width, height; 		public int index;
	...
	static public enum Resampling {
		nearest(RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR), 		bilinear(RenderingHints.VALUE_INTERPOLATION_BILINEAR), 		bicubic(RenderingHints.VALUE_INTERPOLATION_BICUBIC);
