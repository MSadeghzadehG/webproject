...
public class ParticleChannels {
	...
	public static final ChannelDescriptor Position = new ChannelDescriptor(newGlobalId(), float.class, 3); 	public static final ChannelDescriptor PreviousPosition = new ChannelDescriptor(newGlobalId(), float.class, 3);
	...
	public static final ChannelDescriptor Acceleration = new ChannelDescriptor(newGlobalId(), float.class, 3); 	public static final ChannelDescriptor AngularVelocity2D = new ChannelDescriptor(newGlobalId(), float.class, 1);
