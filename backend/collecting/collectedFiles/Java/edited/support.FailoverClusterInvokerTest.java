...
public class FailoverClusterInvokerTest {
    ...
    int retries = 5;
    URL url = URL.valueOf("test:    Invoker<FailoverClusterInvokerTest> invoker1 = EasyMock.createMock(Invoker.class);
    ...
    public void testInvokerDestoryAndReList() {
        final URL url = URL.valueOf("test:        RpcException exception = new RpcException(RpcException.TIMEOUT_EXCEPTION);
