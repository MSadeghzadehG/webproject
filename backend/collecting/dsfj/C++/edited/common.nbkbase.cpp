...
wxREADONLY_PROPERTY( Text, wxString, GetText, wxString(), 0 , \
                    wxT("Helpstring"), wxT("group"))
wxREADONLY_PROPERTY( Selected, bool, GetSelected, false, 0 , \
                    wxT("Helpstring"), wxT("group") )
wxREADONLY_PROPERTY( ImageId, int, GetImageId, -1, 0 , \
                    wxT("Helpstring"), wxT("group"))
...
wxPROPERTY_COLLECTION( PageInfos, wxNotebookPageInfoList, wxNotebookPageInfo*, \
                      AddPageInfo, GetPageInfos, 0 , wxT("Helpstring"), \
                      wxT("group"))
