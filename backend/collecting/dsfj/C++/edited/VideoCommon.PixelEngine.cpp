...
union UPEZConfReg
{
  ...
  struct
  {
    u16 ZCompEnable : 1;      u16 Function : 3;
    u16 ZUpdEnable : 1;
    u16 : 11;
  };
};
...
union UPEAlphaConfReg
{
  ...
  struct
  {
    u16 BMMath : 1;       u16 BMLogic : 1;      u16 Dither : 1;
    u16 ColorUpdEnable : 1;
    u16 AlphaUpdEnable : 1;
    u16 DstFactor : 3;
    u16 SrcFactor : 3;
    u16 Substract : 1;      u16 BlendOperator : 4;
  };
};
...
union UPECtrlReg
{
  struct
  {
    ...
    u16 PEToken : 1;       u16 PEFinish : 1;      u16 : 12;
  };
  u16 Hex;
  UPECtrlReg() { Hex = 0; }
...
enum
{
  INT_CAUSE_PE_TOKEN = 0x200,     INT_CAUSE_PE_FINISH = 0x400,  };
  ...
  for (auto& pq_reg : pq_regs)
  {
    ...
    mmio->Register(base | PE_CTRL_REGISTER, MMIO::DirectRead<u16>(&m_Control.Hex),
                 MMIO::ComplexWrite<u16>([](u32, u16 val) {
                   ...
                   m_Control.PEToken = 0;                      m_Control.PEFinish = 0;  
