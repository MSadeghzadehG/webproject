...
Country CountrySwitch(u8 country_code)
{
  ...
  case 'X':    case 'Y':    case 'L':    case 'M':    case 'P':
    return Country::COUNTRY_EUROPE;
  ...
  case 'S':
    ...
    case 'E':
  case 'N':    case 'Z':    case 'B':      return Country::COUNTRY_USA;

  case 'J':
    return Country::COUNTRY_JAPAN;

  case 'K':
  case 'Q':    case 'T':      return Country::COUNTRY_KOREA;

  case 'W':
    return Country::COUNTRY_TAIWAN;

  default:
    if (country_code > 'A')        WARN_LOG(DISCIO, "Unknown Country Code! %c", country_code);
    return Country::COUNTRY_UNKNOWN;
  }
}
