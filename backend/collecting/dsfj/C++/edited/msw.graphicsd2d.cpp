...
void wxD2DPathData::AddArc(wxDouble x, wxDouble y, wxDouble r, wxDouble startAngle, wxDouble endAngle, bool clockwise)
{
    ...
    D2D1_ARC_SEGMENT arcSegment = {
        { (FLOAT)(end.m_x + x), (FLOAT)(end.m_y + y) },             { (FLOAT)r, (FLOAT) r },                                 0,                                      sweepDirection,                         arcSize                             };
...
void wxD2DPathData::AddEllipse(wxDouble x, wxDouble y, wxDouble w, wxDouble h)
{
    ...
    {
        D2D1::Point2((FLOAT)(x + w), (FLOAT)(y + ry)),         D2D1::SizeF((FLOAT)(rx), (FLOAT)(ry)),                 0.0f,
    ...
    {
        D2D1::Point2((FLOAT)(x), (FLOAT)(y + ry)),             D2D1::SizeF((FLOAT)(rx), (FLOAT)(ry)),                 0.0f,
        D2D1_SWEEP_DIRECTION_CLOCKWISE,
        D2D1_ARC_SIZE_SMALL
    };
...
protected:
    void DoAcquireResource() wxOVERRIDE
    {
        ...
        const unsigned char *imgRGB = m_resultImage->GetData();            const unsigned char *imgAlpha = m_resultImage->GetAlpha();         for( int y = 0; y < height; y++ )
        {
...
protected:
        ...
        void DoAcquireResource() wxOVERRIDE
    {
        ...
        hr = D3D11CreateDevice(
            ...
            &device,                                &m_featureLevel,                        &context);                          wxCHECK_HRESULT_RET(hr);
...
void wxD2DContext::DrawEllipse(wxDouble x, wxDouble y, wxDouble w, wxDouble h)
{
    ...
    D2D1_ELLIPSE ellipse = {
        { (FLOAT)(x + w / 2), (FLOAT)(y + h / 2) },         (FLOAT)(w / 2),                              (FLOAT)(h / 2)                           };
