    ...
    : m_glContext(NULL)
{
    ...
    wglDeleteContext(tempContext);
        ...
        if ( !wglCreateContextAttribsARB && needsARB )     {
                                        ...
                                        PIXELFORMATDESCRIPTOR* ppfd)
{
    ...
    if ( !dummyHDC )
    {
        ...
        PIXELFORMATDESCRIPTOR dpfd;     ::SetPixelFormat(dummyHDC, 1, &dpfd);     HGLRC dumctx = ::wglCreateContext(dummyHDC);
    if ( !dumctx )
    {
        dummyWin->Destroy();
