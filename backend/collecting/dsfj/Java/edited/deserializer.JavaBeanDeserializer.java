...
public class JavaBeanDeserializer implements ObjectDeserializer {
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
        final JSONLexer lexer = parser.lexer;         if (lexer.token() != JSONToken.LBRACKET) {
    ...
    protected <T> T deserialze(DefaultJSONParser parser,                                Type type,                                Object fieldName,                                Object object,                                int features,                                int[] setFlags) {
        ...
        final JSONLexerBase lexer = (JSONLexerBase) parser.lexer;         final ParserConfig config = parser.getConfig();
        ...
        try {
            ...
            for (int fieldIndex = 0;; fieldIndex++) {
                ...
                if (fieldDeser != null) {
                    ...
                    } else if (fieldClass.isEnum()                             && parser.getConfig().getDeserializer(fieldClass) instanceof EnumDeserializer
