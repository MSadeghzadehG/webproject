...
public class JSONPath_deepScan_test extends TestCase {
    ...
    public void test_0() throws Exception {
        Map root = Collections.singletonMap("company",                                             Collections.singletonMap("departs",                                                                      Arrays.asList(                                                                                     Collections.singletonMap("id",
                                                                                                             1001),                                                                                     Collections.singletonMap("id",
                                                                                                             1002),                                                                                     Collections.singletonMap("id", 1003)                                                                      )                                             ));
