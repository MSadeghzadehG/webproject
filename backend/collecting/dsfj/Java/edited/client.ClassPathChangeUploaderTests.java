...
public class ClassPathChangeUploaderTests {
	...
	public void setup() {
		...
		this.uploader = new ClassPathChangeUploader("http:				this.requestFactory);
	}
	...
	public void requestFactoryMustNotBeNull() {
		...
		new ClassPathChangeUploader("http:	}

	@Test
	public void urlMustNotBeMalformed() {
		this.thrown.expect(IllegalArgumentException.class);
		this.thrown.expectMessage("Malformed URL 'htttttp:		new ClassPathChangeUploader("htttttp:	}
