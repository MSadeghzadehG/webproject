...
@Ignore public class CollectionIteratorTester<E> extends AbstractCollectionTester<E> {
  public void testIterator() {
    List<E> iteratorElements = new ArrayList<E>();
    for (E element : collection) {       iteratorElements.add(element);
    }
  ...
  public void testIterator_removeAffectsBackingCollection() {
    ...
    assertTrue(collection.contains(element));     iterator.remove();
