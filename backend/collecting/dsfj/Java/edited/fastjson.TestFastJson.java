...
public class TestFastJson {
    ...
    private RatePlanDTO createExpectedRatePlan() {
        ...
        ratePlan.setPaymentType(PAYMENT_TYPE_POA);         ratePlan.setTaxes(createExpectedTaxs());
        ...
        ratePlan.setAvailGuarantees(createExpectedAvailGuarantee());         ratePlan.setFreeMeal(createExpectedFreeMeal());
        return ratePlan;
    }
