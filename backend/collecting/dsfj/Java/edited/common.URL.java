...
public final class URL implements Serializable {
    ...
    private Map<String, Number> getNumbers() {
        if (numbers == null) {             numbers = new ConcurrentHashMap<String, Number>();
        }
        return numbers;
    }

    private Map<String, URL> getUrls() {
        if (urls == null) {             urls = new ConcurrentHashMap<String, URL>();
        }
        return urls;
    }
    ...
    public URL addParameter(String key, String value) {
        if (key == null || key.length() == 0
            ...
            return this;
                ...
                if (value.equals(getParameters().get(key))) {             return this;
        }
