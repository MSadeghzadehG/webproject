	...
	public ObjectSerializer createJavaBeanSerializer(SerializeBeanInfo beanInfo) {
		...
		if (asm) {
    		for(FieldInfo fieldInfo : beanInfo.fields){
                ...
                if ((!ASMUtils.checkName(annotation.name()))                         || annotation.jsonDirect()
                ...
                if (className.startsWith("java.awt.")                     && AwtCodec.support(clazz)                 ) {
                        ...
                        try {
                            ...
                            awtError = true;
                                ...
                                if ((!jdk8Error)                     && (className.startsWith("java.time.")                         || className.startsWith("java.util.Optional")                         || className.equals("java.util.concurrent.atomic.LongAdder")
