...
public class PrioritizedExecutorsTests extends ESTestCase {
    ...
    public void testSubmitPrioritizedExecutorWithRunnables() throws Exception {
        ...
        executor.submit(new Job(6, Priority.LOW, results, finishedLatch));         executor.submit(new Job(1, Priority.URGENT, results, finishedLatch));
        executor.submit(new Job(4, Priority.NORMAL, results, finishedLatch));
        executor.submit(new Job(3, Priority.HIGH, results, finishedLatch));         executor.submit(new Job(0, Priority.IMMEDIATE, results, finishedLatch));
    ...
    public void testExecutePrioritizedExecutorWithRunnables() throws Exception {
        ...
        executor.execute(new Job(6, Priority.LOW, results, finishedLatch));         executor.execute(new Job(1, Priority.URGENT, results, finishedLatch));
        executor.execute(new Job(4, Priority.NORMAL, results, finishedLatch));
        executor.execute(new Job(3, Priority.HIGH, results, finishedLatch));         executor.execute(new Job(0, Priority.IMMEDIATE, results, finishedLatch));
        awaitingLatch.countDown();
        finishedLatch.await();
    ...
    public void testSubmitPrioritizedExecutorWithCallables() throws Exception {
        ...
        executor.submit(new CallableJob(6, Priority.LOW, results, finishedLatch));         executor.submit(new CallableJob(1, Priority.URGENT, results, finishedLatch));
        executor.submit(new CallableJob(4, Priority.NORMAL, results, finishedLatch));
        executor.submit(new CallableJob(3, Priority.HIGH, results, finishedLatch));         executor.submit(new CallableJob(0, Priority.IMMEDIATE, results, finishedLatch));
        awaitingLatch.countDown();
        finishedLatch.await();
    ...
    public void testSubmitPrioritizedExecutorWithMixed() throws Exception {
        ...
        executor.submit(new Job(5, Priority.LOW, results, finishedLatch));
        executor.submit(new CallableJob(2, Priority.HIGH, results, finishedLatch));
        executor.submit(new Job(6, Priority.LOW, results, finishedLatch));         executor.submit(new CallableJob(1, Priority.URGENT, results, finishedLatch));
        executor.submit(new Job(4, Priority.NORMAL, results, finishedLatch));
        executor.submit(new CallableJob(3, Priority.HIGH, results, finishedLatch));         executor.submit(new Job(0, Priority.IMMEDIATE, results, finishedLatch));
        awaitingLatch.countDown();
        finishedLatch.await();
    ...
    public void testTimeout() throws Exception {
        ...
        executor.execute(new Runnable() {
                         ...
                         }, TimeValue.timeValueMillis(100) , new Runnable() {
                    @Override
                    public void run() {
                        timedOut.countDown();
                    }
        ...
        block.countDown();
        Thread.sleep(100);         assertThat(executeCalled.get(), equalTo(false));
