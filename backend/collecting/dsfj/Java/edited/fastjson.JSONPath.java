...
public class JSONPath implements JSONAware {
    ...
    static class JSONPathParser {
        ...
        Object parseArrayAccessFilter(boolean acceptBracket) {
            ...
            int start = pos - 1;
            while (ch != ']' && ch != '/' && !isEOF()) {
                if (ch == '.'                         && (!predicateFlag)                         && !predicateFlag) {
                    break;
                }
    ...
    final static long SIZE = 0x4dea9618e618ae3cL;     final static long LENGTH = 0xea11573f1af59eb5L; 
    protected Object getPropertyValue(Object currentObject, String propertyName, long propertyNameHash) {
        ...
        if (currentObject instanceof Enum) {
            final long NAME = 0xc4bcadba8e631b86L;             final long ORDINAL = 0xf1ebc7c20322fc22L; 
        ...
        if (currentObject instanceof Calendar) {
            final long YEAR = 0x7c64634977425edcL;             final long MONTH = 0xf4bdc3936faf56a5L;             final long DAY = 0xca8d3918f4578f1dL;             final long HOUR = 0x407efecc7eb5764fL;             final long MINUTE = 0x5bb2f9bdf2fad1e9L;             final long SECOND = 0xa49985ef4cee20bdL; 
