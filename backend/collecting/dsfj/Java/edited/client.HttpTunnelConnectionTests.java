...
public class HttpTunnelConnectionTests {
	...
	public void setup() {
		...
		this.url = "http:		this.incomingData = new ByteArrayOutputStream();
	...
	public void urlMustNotBeMalformed() {
		this.thrown.expect(IllegalArgumentException.class);
		this.thrown.expectMessage("Malformed URL 'htttttp:		new HttpTunnelConnection("htttttp:	}
	...
	public void connectFailureLogsWarning() throws Exception {
		...
		this.outputCapture.expect(containsString(
				"Failed to connect to remote application at http:	}
